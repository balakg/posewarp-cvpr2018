...
def train(dataset,gpu_id):	
	...
	test_feed = datageneration.warpExampleGenerator(test_all,params,drawSkeleton=False,doAugment=False)
	train_feed = datageneration.warpExampleGenerator(test_all,params,drawSkeleton=False,doAugment=False)
